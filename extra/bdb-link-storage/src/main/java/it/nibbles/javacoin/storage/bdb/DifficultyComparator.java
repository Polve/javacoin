 ...
 */
public class DifficultyComparator implements Comparator<byte[]>, Serializable
{

  private DifficultyBinding binding;

  public DifficultyComparator(BitcoinFactory bitcoinFactory) {
    binding = new DifficultyBinding(bitcoinFactory);
  }
